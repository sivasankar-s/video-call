  ...
  return (
    ...
    <div className='flex h-screen w-screen border-4'>
        <div className='bg-gray-100 w-full flex justify-center items-center'>
            <div className='w-1/2 flex flex-col h-52 items-center'>
                ...
                <Link to="/alumniLogin" className='bg-gray-600 w-1/3 text-center text-white p-3 rounded-md font-semibold'>Sign In</Link>
            </div>
        </div>
        ...
        {/* <div className='w-1/2 flex flex-col justify-center'> */}
            <div className='w-1/2 flex flex-col h-52 items-center'>
                ...
                <Link to="/studentLogin" className='border-2 border-black w-1/3 text-center text-black p-3 rounded-md font-semibold'>Sign In</Link>
            </div>
            {/* </div> */}
        </div>
    </div>
